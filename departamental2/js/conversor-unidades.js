    ...
    switch (selectTemperatura_1) {
        case "celsius":
                switch (selectTemperatura_2) {
                    ...
                    case "fahrenheit":
                        ...
                        muestraFormula.innerHTML="ºF = ºC x 1.8 + 32";
                    break;
                    case "kelvin":
                        inputTemperatura_2.value= inputTemperatura_1.value+273.15;
                        muestraFormula.innerHTML="K = ºC + 273.15";
                    break;
                    default:
                        break;
                }
        ...
        case "fahrenheit":
                switch (selectTemperatura_2) {
                    case "celsius":
                            ...
                            muestraFormula.innerHTML="ºC = (ºF-32) ÷ 1.8";
                    break;
                    case "fahrenheit":
                        inputTemperatura_2.value= inputTemperatura_1.value;
                        muestraFormula.innerHTML="Es igual";
                    break;
                    case "kelvin":
                        inputTemperatura_2.value= (5/9)*(inputTemperatura_1.value-32)+273.15;
                        muestraFormula.innerHTML="K = 5/9 (ºF – 32) + 273.15";
                    break;
                    default:
                        break;
                }
        ...
        case "kelvin":
                switch (selectTemperatura_2) {
                    case "celsius":
                            inputTemperatura_2.value= inputTemperatura_1.value-273.15;
                            muestraFormula.innerHTML="ºC = K – 273.15";
                    break;
                    case "fahrenheit":
                        inputTemperatura_2.value= (1.8)*(inputTemperatura_1.value-273.15)+32;
                        muestraFormula.innerHTML="ºF = 1.8*(K – 273.15) + 32";
                    break;
                    case "kelvin":
                        inputTemperatura_2.value = inputTemperatura_1.value;
                        muestraFormula.innerHTML="Es igual";
